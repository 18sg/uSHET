 ...
 *   // terminator.
 *   char json[ SHET_ENCODED_JSON_LENGTH(_, SHET_ARRAY_BEGIN) +
 *              SHET_ENCODED_JSON_LENGTH(my_int, SHET_INT) +
 *              SHET_ENCODED_JSON_LENGTH(my_string, SHET_STRING) +
 *              SHET_ENCODED_JSON_LENGTH(_, SHET_ARRAY_END) +
 *              1 ];
 *
 ...
 *   // proceeding commas.
 *   sprintf(json, SHET_ENCODE_JSON_FORMAT(SHET_INT)
 *                 SHET_ENCODE_JSON_FORMAT(SHET_STRING)
 *                 SHET_ENCODE_JSON_VALUE(_, SHET_ARRAY_BEGIN)
 *                 SHET_ENCODE_JSON_VALUE(my_int, SHET_INT)
 *                 SHET_ENCODE_JSON_VALUE(my_string, SHET_STRING)
 *                 SHET_ENCODE_JSON_VALUE(_, SHET_ARRAY_END));
 *
